...
Olá Seja bem vindo ao meu bot Rasputcha BR está pronta para te ajudar a devastar qualquer coisa necessária 
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("Não está morto...")
...
def donate(bot: Bot, update: Update):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 5185792776 and DONATION_LINK:
