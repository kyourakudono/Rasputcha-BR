...
def send(update, message, keyboard, backup_message):
    ...
    try:
        ...
        msg = update.effective_message.reply_text(markdown_parser(backup_message +
                                                                  ...
                                                                  "parênteses encaracolados. Por favor atualize"),
                                                  parse_mode=ParseMode.MARKDOWN)
    except BadRequest as excp:
        if excp.message == "Button_url_invalid":
            msg = update.effective_message.reply_text(markdown_parser(backup_message +
                                                                      "\nNote: a mensagem atual tem um URL inválido "
        ...
        elif excp.message == "Mensagem respondida não encontrada":
            LOGGER.warning("Mensagem original excluída")            
        elif excp.message == "Não têm direitos para enviar uma mensagem":
            LOGGER.warning("Silenciado no bate-papo abaixo")
            print(update.effective_message.chat.id)
        else:
            msg = update.effective_message.reply_text(markdown_parser(backup_message +
                                                                      "\nNote: Ocorreu um erro ao enviar o "
